...
app.post("/submit", (req, res) => {
  ...
  let adjNumber= randomNumber(adj.length);
  let nounNumber = randomNumber(noun.length);

  const data = {
    name: adj[adjNumber] + " " + noun[nounNumber],
  }
  
  //console.log(adj[adjNumber] + noun[nounNumber]);
